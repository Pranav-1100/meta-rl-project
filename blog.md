...
Both models converged cleanly. 275 SFT trajectories across 9 task types, generated by Claude-as-agent.
...
| SFT model | [from eval run] | [from eval run] | Trained to be honest |
