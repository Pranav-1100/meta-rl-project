...
| Model | Loss start → end | Token accuracy | Time on A10G |
|---|---|---|---|
| Qwen 2.5 7B | 1.93 → 1.57 | 64.8% | 19.3 min |
| Gemma 2 9B | 1.84 → 1.28 | 70.9% | 30.3 min |

Both models converged cleanly. 275 SFT trajectories across 9 task types, generated by Claude-as-agent. Per-step loss history is saved on each model's Hub repo at [`training_log.json`](https://huggingface.co/pranav-1100/phonepilot-qwen7b/blob/main/training_log.json).
